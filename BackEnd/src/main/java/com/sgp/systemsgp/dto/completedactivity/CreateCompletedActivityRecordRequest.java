...
@Getter
@Setter
public class CreateCompletedActivityRecordRequest {
    ...
    @Valid
    @Size(max = 120, message = "No se pueden registrar más de 120 actividades")
    private List<CompletedActivityRecordEntryRequest> entries;
