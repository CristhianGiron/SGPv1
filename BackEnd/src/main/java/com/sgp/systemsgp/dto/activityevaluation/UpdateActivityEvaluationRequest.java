...
@Getter
@Setter
public class UpdateActivityEvaluationRequest {
    ...
    @Valid
    @Size(max = 60, message = "No se pueden registrar más de 60 aspectos")
    private List<ActivityEvaluationAspectRequest> aspects;

    @PositiveOrZero(message = "Las horas cumplidas no pueden ser negativas")
    @Max(value = 200000, message = "Las horas cumplidas son demasiado altas")
    private Integer hoursCompleted;

    @DecimalMin(value = "0.0", message = "El porcentaje de cumplimiento no puede ser menor que 0")
    @DecimalMax(value = "100.0", message = "El porcentaje de cumplimiento no puede superar 100")
